          ...
          <Flex direction="column" gap="4">
            ...
            <Box>
              <TextField.Root
                ...
                type="password"
                {...register("password",
                  { required: t("login_page.password_required"), minLength: { value: 10, message: t("login_page.password_min_length") } })}
                placeholder={t("login_page.password_placeholder")} />
              <ErrorLabel error={errors.password?.message} id={"password"} />
            </Box>
          </Flex>
          <Button className="p-5 w-100 mt-5" type="submit" >{t("login_page.login_button")}</Button>
        </form>
      </div>
    </PageSizeWrapper>
